...
<div class="alert">
<b><p>The site was offline beginning 2021-03-09 due to Missouri acknowledging approximately 80,000 cases identified using antigen ("rapid") tests. Approximately 50,000 of these cases were not accounted for on this site. You can read a bit more [about the issue on Chris's newsletter](https://chrisprener.substack.com/p/weekly-covid-19-round-up-31121).</p>

As of 2021-03-14, Chris has completed updating plots to reflect the change in case counts. 7-day average data at the county level will not be updated until 2020-03-16, however, so that trends do not show the very large spikes due to the addition of these 50,000 new cases. </p>

<p>Thanks for your patience as the site was offline!</p></b>
</div>
<br>
