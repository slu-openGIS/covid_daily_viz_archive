...
<div class="alert">
The State of Missouri has restored its dashboard as of October 14th. Due to the data issues over the past two weeks, 7-day averages have been impacted significantly. Trends may not be due to current volume of new cases. This will be the case through October 23rd, assuming there are no additional disruptions. Please note, additionally, that the City of St. Louis has not updated their zip code data in several days. It is not known if this is related to the State's outage.
</div>
...
<div class="row">
  ...
  <div class="column">
  <a href="lct.html">`r fa("chart-pie", height = 40)`</i>
