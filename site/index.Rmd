...
Select an area below to view additional plots that focus on trends within a variety of areas of Missouri. *This section is a work in progress.*

<br>

<div class="row">
  <div class="column">
  <a href="kc.html">`r fa("chart-line", height = 40)`</i>
...
The most recent versions of plots not yet included in the new sub-pages in the previous section can be found below. *As I add new sub-pages above, I will remove these tabs below.*
