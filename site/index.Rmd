...
<div class="alert">
 <b>Updates to the site will not be made after 2020-12-31 due to the New Year's holiday. Updates will resume 2020-12-29. All daily background data will continue, though we've already had some local public health departments pause data updates, and some will likely remain without update until 2021-01-04. Given our experience with Thanksgiving and Christmas, we also anticipate minimal data updates from Missouri on New Year's Eve and Day. These delays, combined with a lingering instability from Christmas, mean that our daily numbers will be unstable through 2021-01-04 and our 7-day averages will be unstable through 2021-01-11.</b>
 </div>
 <br>
 
<div class="note">
<b>The site was last updated on `r Sys.Date()`. All county, metro, and state level morbidity and mortality data are current as of `r Sys.Date()-1`. ZIP code, disparity, and St. Louis hospitalization data are all current as of `r Sys.Date()`. </b>
</div>
<br>
...
<div class="row">
  ...
  <br><p style="font-size:20px">States</p></a></div>
  <div class="column">
  <a href="regions.html">`r fa("chart-pie", height = 40)`</i>
  <br><p style="font-size:20px">Meso Regions</p></div>
  <div class="column">
  <a href="metros.html">`r fa("chart-line", height = 40)`</i>
  <br><p style="font-size:20px">Metro Areas</p></div></div>
</div>
<div class="row">
  <div class="column">
...
<div class="row">
  <div class="column">
  <a href="disparities.html">`r fa("chart-pie", height = 40)`</i>
  <br><p style="font-size:20px">Disparities</p></a><p>Includes race, sex, and poverty data for Missouri and St. Louis</p></div>
  <div class="column">
  <a href="ltc.html">`r fa("chart-line", height = 40)`</i>
  <br><p style="font-size:20px">Nursing Homes</p></a><p>Includes facility and county data for Missouri</p></div>
  <div class="column">
  <a href="mortality.html">`r fa("chart-area", height = 40)`</i>
  <br><p style="font-size:20px">Mortality</p></a><p>Includes excess mortality and comparisons of actual vs. reported deaths</p></div>
</div>
