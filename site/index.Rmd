...
<div class="alert">
The State of Missouri has restored its dashboard as of October 14th. I am hoping to restore updates to this website on the 15th. All statewide, regional, metro, and county-level data are affected by this (with the exceptions of St. Louis City and County). St. Louis ZIP Code, disparity, and hospitalization data are not affected by this issue, and will continue to be updated. Please note, however, that the City of St. Louis has not updated their zip code data in several days. It is not known if this is related to the State's outage.
</div>
