...
<div class="alert">
The State of Missouri has not updated its data since Saturday, October 10th. Data on this site show a drop for the October 11th report date. I've made the decision to pause most updates for the next few days until they begin updating their dashboard again. All statewide, regional, metro, and county-level data are affected by this (with the exceptions of St. Louis City and County). St. Louis ZIP Code, disparity, and hospitalization data are not affected by this issue, and will continue to be updated.
</div>
