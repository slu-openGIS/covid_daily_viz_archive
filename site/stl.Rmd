...
```{r metro-infection-avg-log, echo=FALSE, out.width = '100%'}
knitr::include_graphics("img/stl_metro/f_new_case_log.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/stl_metro/f_new_case_log.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/stl_metro/f_new_case_log.png" target="_blank">Low-res</a>]
...
knitr::include_graphics("img/stl_metro/i_mortality_log.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/stl_metro/i_mortality_log.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/stl_metro/i_mortality_log.png" target="_blank">Low-res</a>]
...
# calculate breaks
bins <- map_bins(zip_snapshot, var = "case_avg_rate", style = "quantile", classes = 5, dig_lab = 2,
                 round = 2)
...
leaflet() %>%
  ...
  addPolygons(
    ...
    popup = paste0("<b>Zip:</b> ", zip_snapshot$GEOID_ZCTA, " <br> ",
                 "<b>Current Cumulative Count:</b> ", zip_snapshot$cases, "<br>",
                 "<b>Current 14-day Average Rate per 10,000:</b> ", round(zip_snapshot$case_avg_rate, digits = 2), " <br> ",
                 "<b>Population Below Poverty Line:</b> ", round(zip_snapshot$pvty_pct, digits = 2), "% <br> ",
                 "<b>African American Population:</b> ", round(zip_snapshot$blk_pct, digits = 2), "% ")
  )  %>%
  addPolylines(
...
knitr::include_graphics("img/stl_zip/d_avg_map_regional.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/stl_zip/d_avg_map_regional.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/stl_zip/d_avg_map_regional.png" target="_blank">Low-res</a>]
