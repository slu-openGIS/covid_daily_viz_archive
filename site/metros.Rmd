...
# load data
metro_data <- read_csv(here::here("data", "MO_HEALTH_Covid_Tracking", "data", "metro_all", "metro_full.csv")) %>%
...
```{r metro-infection-avg-rate, echo=FALSE, out.width = '100%'}
...
knitr::include_graphics("img/metro/f_new_case_log.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/metro/f_new_case_log.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/metro/f_new_case_log.png" target="_blank">Low-res</a>]
...
knitr::include_graphics("img/metro/i_mortality_log.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/metro/i_mortality_log.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/metro/i_mortality_log.png" target="_blank">Low-res</a>]

### New Mortality

```{r metro-death-log-avg, echo=FALSE, out.width = '100%'}
knitr::include_graphics("img/metro/k_mortality_log_avg.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/metro/k_mortality_log_avg.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/metro/k_mortality_log_avg.png" target="_blank">Low-res</a>]
