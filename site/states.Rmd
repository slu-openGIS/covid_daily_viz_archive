...
```{r state-infection-avg-log, echo=FALSE, out.width = '100%'}
knitr::include_graphics("img/state/f_new_case_log.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/state/f_new_case_log.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/state/f_new_case_log.png" target="_blank">Low-res</a>]
...
knitr::include_graphics("img/state/i_mortality_log.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/state/i_mortality_log.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/state/i_mortality_log.png" target="_blank">Low-res</a>]

### New Mortality

```{r state-death-log-avg, echo=FALSE, out.width = '100%'}
knitr::include_graphics("img/state/k_mortality_log_avg.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/state/k_mortality_log_avg.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/state/k_mortality_log_avg.png" target="_blank">Low-res</a>]
