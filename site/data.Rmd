...
## Workflow
Data production, plotting, and the generation of this website all use the programming language `R`. The workflows are split into three processes - an "AM" process that builds data from the New York Times, a "PM" process that builds data from other sources, and a final site building process to create this site itself. All source code is available in this project's <a href="https://github.com/slu-openGIS/covid_daily_viz" target = "_blank">GitHub repository</a>.
