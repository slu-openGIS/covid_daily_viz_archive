...
stl_race <- read_csv(here::here("data", "individual", "stl_race_rates.csv"))
stl_race_gender <- read_csv(here::here("data", "individual", "stl_race_gender_rates.csv"))
zip_snapshot <- st_read(here::here("data", "zip", "daily_snapshot_city_county.geojson")) %>%
