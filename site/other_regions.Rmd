...
cape <- filter(county_data, geoid %in% c("29031", "29157", "29186",  "29187",
                  "29017", "29221", "29123"))
mid_mo <- filter(county_data, geoid %in% c("29135", "29019", "29051", "29007", 
                  "29027", "29053", "29151"))
ozark <- filter(county_data, geoid %in% c("29029", "29131", "29141", "29015",
                  "29169", "29105", "29125", "29161"))
ozark_mtns <- filter(county_data, geoid %in% c("29153", "29215", "29091", "29229"))
nomo <- filter(county_data, geoid %in% c("29211", "29001", "29075",
                  "29127", "29163", "29173", "29117", "29175"))
semo <- filter(county_data, geoid %in% c("29511", "29133", "29155", 
                  "29201",  "29207", "29143", "29023", "29069"))
spring <- filter(county_data, geoid %in% c("29043", "29077", "29167", 
                  "29213", "29209", "29225"))
st_jo <- filter(county_data, geoid %in% c("29003", "29021", "29063", "29049",
                  "29147"))
swmo <- filter(county_data, geoid %in% c("29097", "29119", "29145", "29011", 
                  "29009", "29512"))
...
<div class="alert">
<b>Nodaway County, which had been included in the "Northern Missouri" plots, is now included in the "St. Joseph and Northwestern Missouri" plots.</b>
</div>
...
```{r ozkmtn-infection-log, echo=FALSE, out.width = '100%'}
knitr::include_graphics("img/county_ozkmtns/c_case_log.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/county_ozkmtns/c_case_log.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/county_ozkmtns/c_case_log.png" target="_blank">Low-res</a>]
