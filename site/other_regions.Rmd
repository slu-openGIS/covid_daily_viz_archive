...
### Notes
  ...
  * The FAQ contains short explanations of [per-capita rates](faq.html#What_are_Per_Capita_Rates) and [log plots rates](faq.html#What_are_Log_Plots).
...
These plots show patterns in infections for a number of counties in the southwestern part Missouri, including parts (but not all of) of the Joplin and Springfield <a href="faq.html#What_is_a_Metropolitan_Statistical_Area">metro areas</a>.
