...
```{r nemo-infection-log, echo=FALSE, out.width = '100%'}
knitr::include_graphics("img/county_nemo/c_case_log.png")
```

Download: [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/high_res/county_nemo/c_case_log.png" target="_blank">High-res</a>] [<a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/county_nemo/c_case_log.png" target="_blank">Low-res</a>]
