...
knitr::include_graphics(here::here("results", "high_res", "zip", "b_poverty_plot.png"))
```

### Race (Zip Code)

```{r race-zip-plot, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("results", "high_res", "zip", "c_race_plot.png"))
```

### Race, Morbidity (Individual)

```{r race-individual-morbidity, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("results", "high_res", "individual", "a_race_case.png"))
```

### Race, Mortality (Individual)

```{r race-individual-mortality, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("results", "high_res", "individual", "a_race_mortality.png"))
```
...
| Links |  |  |
|-------------------------|--|--|
| <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/metro/b_case_rate.png" target="_blanl">Reported Cases (Rate)</a> | <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/metro/c_case_log.png" target="_blanl">Reported Cases (Log)</a> | |
| <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/metro/f_mortality_rate.png" target="_blanl">Mortality (Rate)</a> | <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/metro/g_mortality_log.png" target="_blanl">Mortality (Log)</a> | |
...
| Links |  |  |
|-------------------------|--|--|
| <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/county/a_case_map.png" target="_blanl">Reported Cases (Map)</a> | <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/county/b_case_rate.png" target="_blanl">Reported Cases (Rate)</a> | <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/county/c_case_log.png" target="_blanl">Reported Cases (Log)</a> |
| <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/county/e_mortality_map.png" target="_blanl">Mortality (Map)</a> | <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/county/i_case_fatality.png" target="_blanl">Case Fatality (Map)</a> | |

### St. Louis Metro

| Links |  |  |
|-------------------------|--|--|
| <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/stl_metro/a_confirmed_map.png" target="_blanl">Reported Cases (Map)</a> | <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/stl_metro/b_case_rate.png" target="_blanl">Reported Cases (Rate)</a> | <a href="https://raw.githubusercontent.com/slu-openGIS/covid_daily_viz/master/results/low_res/stl_metro/c_case_log.png" target="_blanl">Reported Cases (Log)</a> |
