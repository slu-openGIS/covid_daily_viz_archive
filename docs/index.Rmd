...
```{r race-individual-morbidity-mo, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("results", "high_res", "mo_individual", "a_race_case.png"))
```

#### Race, Mortality

```{r race-individual-mortality-mo, echo=FALSE, out.width = '100%'}
knitr::include_graphics(here::here("results", "high_res", "mo_individual", "b_race_mortality.png"))
```
