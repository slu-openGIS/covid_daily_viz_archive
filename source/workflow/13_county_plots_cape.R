...
## save plot
save_plots(filename = "results/high_res/county_cape/e_new_case_last21.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_cape/e_new_case_last21.png", plot = p, preset = "lg", dpi = 72)
