# plot county level data - Lake of the Ozarks Focus
...
cols <- c("St. Louis City" = values$pal[1], "St. Louis" = values$pal[2], 
          ...
          "Phelps" = values$pal[11], "Dent" = values$pal[12])

# define focal metros
county_focal <- c("29510", "29189", "29511", regional_geoids$ozark)
...
## save plot
save_plots(filename = "results/high_res/county_ozark/e_new_case.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_ozark/e_new_case.png", plot = p, preset = "lg", dpi = 72)
...
## save plot
save_plots(filename = "results/high_res/county_ozark/e_new_case_last21.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_ozark/e_new_case_last21.png", plot = p, preset = "lg", dpi = 72)
