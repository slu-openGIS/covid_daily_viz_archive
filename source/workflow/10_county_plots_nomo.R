...
cols <- c("St. Louis City" = values$pal[1], "St. Louis" = values$pal[2], 
          ...
          "Livingston" = values$pal[11], "Monroe" = values$pal[12])
...
p <- facet_rate(county_subset, 
                ...
                caption = paste0(values$caption_text_census,"\nValues above 180 for Livingston County truncated to increase readability"))

## save plot
save_plots(filename = "results/high_res/county_nomo/e_new_case.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_nomo/e_new_case.png", plot = p, preset = "lg", dpi = 72)
