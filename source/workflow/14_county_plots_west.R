...
# define focal metros
county_focal <- c("29510", "29189", "29511", "29033", "29101", "29159", "29195")
...
## save plots
save_plots(filename = "results/high_res/county_west/c_case_log.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_west/c_case_log.png", plot = p, preset = "lg", dpi = 72)
