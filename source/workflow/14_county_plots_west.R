...
cols <- c("St. Louis City" = values$pal[1], "St. Louis" = values$pal[2], 
          ...
          "St. Clair" = values$pal[9], "Vernon" = values$pal[10],
          "Cedar" = values$pal[11], "Chariton" = values$pal[12])
...
## save plot
save_plots(filename = "results/high_res/county_west/b_case_rate.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_west/b_case_rate.png", plot = p, preset = "lg", dpi = 72)
...
save_plots(filename = "results/low_res/county_west/e_new_case.png", plot = p, preset = "lg", dpi = 72)
...
## save plot
save_plots(filename = "results/high_res/county_west/e_new_case_last21.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_west/e_new_case_last21.png", plot = p, preset = "lg", dpi = 72)
