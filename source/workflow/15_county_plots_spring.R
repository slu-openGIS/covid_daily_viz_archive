...
# define focal metros
county_focal <- c("29510", "29189", "29511", "29043", "29077", "29167", "29213")
...
## save plots
save_plots(filename = "results/high_res/county_spring/c_case_log.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_spring/c_case_log.png", plot = p, preset = "lg", dpi = 72)

# =============================================================================

# clean-up
rm(county_data, county_subset, county_points, county_day_points, report_day_points, report_points, 
   report_label, report_line, county_focal, county_log_x, county_log_y, county_log_max)
