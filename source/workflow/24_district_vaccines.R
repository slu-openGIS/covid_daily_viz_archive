...
## define top_val
top_val <- round_any(x = max(district$initiated_rate, na.rm = TRUE), accuracy = 20, f = ceiling)
...
## define top_val
top_val <- round_any(x = max(district$last7_rate, na.rm = TRUE), accuracy = 5, f = ceiling)
