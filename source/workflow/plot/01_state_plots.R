...
report_line <- tibble(
  ...
  case_rate = state_case_rate_y,
  mortality_rate = state_mortality_rate_y,
  case_fatality_rate = state_case_fatality_rate_y,
...
# clean-up
rm(state_data, state_subset, state_points, report_points, report_label, report_line, report_line,
