...
p <- ggplot(data = county_subset) +
  ...
  scale_x_continuous(limits = c(0, top_val), breaks = seq(0, top_val, by = 5)) +
  labs(
    title = "Pace of New COVID-19 Deaths in Metro Kansas City",
    subtitle = paste0("Current as of ", as.character(date)),
    caption = caption_text,
...
save_plots(filename = "results/high_res/kc_metro/h_mortality_log_avg.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/kc_metro/h_mortality_log_avg.png", plot = p, preset = "lg", dpi = 72)
