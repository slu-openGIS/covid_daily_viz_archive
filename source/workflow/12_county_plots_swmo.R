...
p <- ggplot() +
  ...
  labs(
    ...
    subtitle = paste0("Southwestern Missouri Focus\n", as.character(values$plot_date), " through ", 
...
## save plot
save_plots(filename = "results/high_res/county_swmo/b_case_rate.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_swmo/b_case_rate.png", plot = p, preset = "lg", dpi = 72)
...
## save plots
save_plots(filename = "results/high_res/county_swmo/c_case_log.png", plot = p, preset = "lg")
save_plots(filename = "results/low_res/county_swmo/c_case_log.png", plot = p, preset = "lg", dpi = 72)
...
save_plots(filename = "results/low_res/county_swmo/e_new_case.png", plot = p, preset = "lg", dpi = 72)
