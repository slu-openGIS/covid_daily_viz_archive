...
## download
counties <- counties(state = c(5, 17, 20, 29, 40), cb = FALSE, class = "sf")
...
# get population data
## state populations
state_pop <- get_acs(geography = "state", state = c("Arkansas", "Kansas", "Illinois", "Missouri", "Oklahoma"), year = 2018,
...
county_pop <- get_acs(geography = "county", state = c("Arkansas", "Kansas", "Illinois", "Oklahoma"), year = 2018,
                      variables = "B01001_001") %>%
